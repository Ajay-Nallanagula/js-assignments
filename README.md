...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Ajay-Nallanagula/js-assignments.svg?branch=master)](https://travis-ci.org/Ajay-Nallanagula/js-assignments)
...
* Run `git clone https://github.com/Ajay-Nallanagula/js-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/Ajay-Nallanagula/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
